          ...
          <div className="hidden min-[480px]:flex items-center space-x-8">
            ...
            >
              <button
                ...
                className={`flex items-center ${theme === 'dark' ? 'text-white' : 'text-black'} hover:text-[#79BAEC] transition-colors duration-200`}
                aria-haspopup="true"
            ...
            <Link
              to="/aboutus"
              className={`${theme === 'dark' ? 'text-white' : 'text-black'} hover:text-[#79BAEC] transition-colors duration-200`}
            >
  ...
  return (
    <>
                    <button
                      ...
                      style={{backgroundColor: '#79BAEC'}} onClick={() => setIsAvatarDropdownOpen((v) => !v)}>
                      {initials}
                    </button>
                    {isAvatarDropdownOpen && (
                      <div id="avatar-dropdown" className={`absolute right-0 mt-2 w-40 rounded-md shadow-lg border py-2 z-50 ${theme === 'dark' ? 'bg-[#1E2A38] border-[#141B25]' : 'bg-white border-gray-200'}`}> 
                        {email === 'admin@enkonix.in' && (
                          <button
                            className={`block w-full text-left px-4 py-2 ${theme === 'dark' ? 'text-white hover:bg-[#79BAEC]' : 'text-gray-800 hover:bg-blue-100'}`}
